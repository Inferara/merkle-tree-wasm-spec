...
- [Formal Properties of the Merkle Tree Algorithm](#formal-properties-of-the-merkle-tree-algorithm)
  ...
  - [Immutability (Integrity)](#immutability-integrity)
  - [Completeness](#completeness)
  - [Soundness](#soundness)
  - [Efficiency (Computational Complexity)](#efficiency-computational-complexity)
  - [Collision Resistance](#collision-resistance)
  - [Preimage Resistance](#preimage-resistance)
  - [Second Preimage Resistance](#second-preimage-resistance)
  - [Proof of Inclusion](#proof-of-inclusion)
  - [Uniqueness of Path](#uniqueness-of-path)
  - [Non-Malleability](#non--malleability)
  - [Data Confidentiality](#data-confidentiality)
  - [Stateless Verification](#stateless-verification)
  - [Tree Balance Handling](#tree-balance-handling)
  - [Inductive Construction](#inductive-construction)
